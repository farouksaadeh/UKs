--Aufgabe 7.1: Datensätze Gruppieren


--Durchschnittspreis alle Produkte Ohne GROUP BY
SELECT AVG(price) AS avg_price FROM product;

--Anzahl Produkte pro Produktkategorie. Hinweis: verwenden Sie den Fremdschlüssel für die Gruppierung
SELECT
 fk_category_id,
 count(*)
FROM
